...
public class AppConfig 
{
		 ...
		 public static boolean saveButtonOnAndOff= true;
		   ...
		   public static String pendingLeasesQuery =" SELECT ID, LeaseEntityID, BuildingEntityID, Company, buildingabbreviation, LeaseName,PortfolioAbbreviation FROM Automation.LeasePdfDecider where PortfolioAbbreviation like '%MCH%'";
